...
sub errexit 
{
    ...
    print "  Your output is different with reference output\n";
    print "  please double check the corresponding /tmp/tshtrace?? directory \n";
   # if ($etrace) {
